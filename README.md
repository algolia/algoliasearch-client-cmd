...
Setup
-------------
To setup the command line client, you have to [download](https://github.com/algolia/algoliasearch-client-cmd/archive/master.zip) and edit `algoliasearch-cmd.sh` and change `API_KEY`, `APPLICATION_ID` and `HOST` with your API-Key and ApplicationID that you can find on your Algolia account.
